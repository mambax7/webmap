...
class webmap_main_get_location extends webmap_view_map
{
    ...
    public function _show_template($apikey)
    {
    ...
    public function _build_template_param($apikey)
    {
        $id = 0;
    ...
    public function build_map($id, $lat, $lng, $zoom)
    {
        $icons   = null;
        $markers = null;
    ...
    public function _utf8_lang($name)
    {
