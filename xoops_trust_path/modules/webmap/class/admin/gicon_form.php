...
// constructor
//---------------------------------------------------------
function webmap_admin_gicon_form( $dirname )
{
	$this->webmap_base_lib_form_lang( $dirname , WEBMAP_TRUST_DIRNAME ) ;
...
function _build_line_image_file()
{
	...
	return $this->build_line_cap_ele( 
		_AM_WEBMAP_GICON_IMAGE_SEL, $desc, $ele );
}
...
function _build_line_shadow_file()
{
	return $this->build_line_ele( 
		_AM_WEBMAP_GICON_SHADOW_SEL, $this->_build_ele_shadow_file() );
}
