...
class webmap_admin_location extends webmap_admin_base
{
    ...
    public function save()
    {
        ...
        if (isset($_POST['webmap_latitude'])) {
            $this->_config_item->save('latitude', (float)$_POST['webmap_latitude']);
        }
        if (isset($_POST['webmap_longitude'])) {
            $this->_config_item->save('longitude', (float)$_POST['webmap_longitude']);
        }
        if (isset($_POST['webmap_zoom'])) {
            $this->_config_item->save('zoom', (int)$_POST['webmap_zoom']);
        }
    }
    ...
    public function build_template_param()
    {
        $arr = array(
