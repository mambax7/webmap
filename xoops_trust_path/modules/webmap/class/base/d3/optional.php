<?php
// $Id: optional.php,v 1.1.1.1 2009/02/23 03:26:45 ohwada Exp $
...
// constructor
//---------------------------------------------------------
function webmap_base_d3_optional()
{
...
function &getInstance()
{
	static $instance;
	if (!isset($instance)) {
		$instance = new webmap_base_d3_optional();
	}
	return $instance;
}
